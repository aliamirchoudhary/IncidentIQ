/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f917637f65915d866481950a481600cb)
// Runtime types generated with workerd@1.20260708.1 2026-07-11 nodejs_compat
interface __BaseEnv_Env {
	incidentiq_db: D1Database;
	AI: Ai;
	INCIDENT_ROOM: DurableObjectNamespace<import("./src/index").IncidentRoom>;
	TIMELINE_AGENT: DurableObjectNamespace /* TimelineAgent from timeline-agent */;
	ROOTCAUSE_AGENT: DurableObjectNamespace /* RootCauseAgent from rootcause-agent */;
	PREVENTION_AGENT: DurableObjectNamespace /* PreventionAgent from prevention-agent */;
	MODERATOR_AGENT: DurableObjectNamespace /* ModeratorAgent from moderator-agent */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IncidentRoom";
	}
